  ...
  return (
    ...
    >
      ...
      <p className="mt-4 max-w-2xl text-center text-base text-balance text-gray-400 sm:mt-8 sm:text-xl">
        Complete peace of mind with SOC2 compliant servers, encrypted data transmission, and a globally distributed infrastructure ensuring 99.99% uptime for your legal documents.
      </p>
