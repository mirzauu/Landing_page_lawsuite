    ...
    <section aria-label="hero">
      <FadeContainer className="relative flex flex-col items-center justify-center">
        ...
        <h1 className="mt-8 text-center text-5xl font-semibold tracking-tighter text-gray-900 sm:text-8xl sm:leading-22">
          <FadeSpan>From</FadeSpan> <FadeSpan>Stenographic reports</FadeSpan>
          <br />
          <FadeSpan>to court-ready</FadeSpan> <FadeSpan>documents</FadeSpan>
        </h1>
        <p className="mt-5 max-w-xl text-center text-base text-balance text-gray-700 sm:mt-8 sm:text-xl">
          <FadeSpan>Convert Stenographic reports and audio into</FadeSpan>{" "}
          <FadeSpan>structured, accurate, and verified</FadeSpan>{" "}
          <FadeSpan>legal documents using advanced AI.</FadeSpan>
        </p>
        <FadeDiv>
          <a
            ...
            href="https://app.verbalex.paperpie.io/"
          >
            Try Now
          </a>
        </FadeDiv>
