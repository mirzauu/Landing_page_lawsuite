      ...
      <div className="grid items-center gap-8 sm:grid-cols-6">
        <div className="sm:col-span-2">
          ...
          <p className="mt-3 mb-8 text-lg text-gray-600">
            Begin your AI-powered legal document processing today or talk to our specialists about your specific needs.
          </p>
        ...
        <div className="relative isolate rounded-xl sm:col-span-4 sm:h-full">
          <Image
            aria-hidden
            alt="Courtroom sketch"
            src="/images/court_sketch.png"
            height={1000}
            width={1000}
